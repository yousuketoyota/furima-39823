class PurchaserAddress # < ApplicationRecord
  ...
  with_options presence: true do
    validates :item_id
    validates :user_id
    # validates :shipping_source_id, numericality: { other_than: 2, message: "can't be blank" }
  ...
  def save
    ...
    # Address.create(postal_code: postal_code, city: city, street_address: street_address, building_name: building_name, phone_number: phone_number)
  end
end
